...
import { CreateRecipeDialog } from '@/features/recipes/CreateRecipeDialog'
...
export function RecipesPage() {
  ...
  const { data: recipes = [], isLoading } = useRecipes(orgId, { search })
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        {canManage && <CreateRecipeDialog organizationId={orgId!} />}
      </div>
